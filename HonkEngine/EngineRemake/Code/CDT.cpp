...
void CDTInit(int width, int height)
{
	...
	cdt_programID = LoadShaders("Assets/Shaders/color_tex_transparency.vert", "Assets/Shaders/color_tex_transparency.frag");
	cdt_blanktex = TextureLoad("Assets/Images/awesomeface.png");
