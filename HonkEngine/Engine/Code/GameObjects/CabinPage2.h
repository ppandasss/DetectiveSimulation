...
public:
	...
	CabinPage2() :Page() {
		...
		Text* N_Clue1 = new Text("N_Clue1", "On the way to stay with their mother", "Assets/Fonts/ESA-smb.ttf");
		N_Clue1->SetPosition(glm::vec3(1.0f, 2.7f, 0.0f));
		N_Clue1->SetColor(glm::vec3(0, 0, 0));
		N_Clue1->SetScale(0.5f);

		Text* N_Clue2 = new Text("N_Clue2", "Not very close with his sister as seemed", "Assets/Fonts/ESA-m.ttf");
		N_Clue2->SetPosition(glm::vec3(1.35f, 2.3f, 0.0f));
		N_Clue2->SetColor(glm::vec3(0, 0, 0));
		N_Clue2->SetScale(0.53f);

		Text* N_Clue3_1 = new Text("N_Clue3_1", "Take medicine daily", "Assets/Fonts/ESA-smb.ttf");
		N_Clue3_1->SetPosition(glm::vec3(1.05f, 1.75f, 0.0f));
		N_Clue3_1->SetColor(glm::vec3(0, 0, 0));
		N_Clue3_1->SetScale(0.52f);

		Text* N_Clue3_2 = new Text("N_Clue3_2", "Chronic illness?", "Assets/Fonts/ESA-smb.ttf");
		N_Clue3_2->SetPosition(glm::vec3(0.95f, 1.4f, 0.0f));
		N_Clue3_2->SetColor(glm::vec3(0, 0, 0));
		N_Clue3_2->SetScale(0.6f);

		Text* N_Clue4_1 = new Text("N_Clue4_1", "Doesn't care about", "Assets/Fonts/ESA-m.ttf");
		N_Clue4_1->SetPosition(glm::vec3(3.45f, 1.65f, 0.0f));
		N_Clue4_1->SetColor(glm::vec3(0, 0, 0));
		N_Clue4_1->SetScale(0.55f);

		Text* N_Clue4_2 = new Text("N_Clue4_2", "the bomb situation", "Assets/Fonts/ESA-m.ttf");
		N_Clue4_2->SetPosition(glm::vec3(3.4f, 1.35f, 0.0f));
		...
		N_LA1->SetPosition(glm::vec3(0.8f, -0.19f, 0.0f));
		N_LA1->SetColor(glm::vec3(0, 0, 0));
		N_LA1->SetScale(0.58f);

		Text* N_LA2 = new Text("N_LA2", "Didn't mention the visit to National Day Event", "Assets/Fonts/ESA-smb.ttf");
		N_LA2->SetPosition(glm::vec3(1.3f, -0.6f, 0.0f));
		N_LA2->SetColor(glm::vec3(0, 0, 0));
		N_LA2->SetScale(0.5f);
		...
		/*m_gameObjects.push_back(N_Clue1);
		m_gameObjects.push_back(N_Clue2);
		m_gameObjects.push_back(N_Clue3_1);
		m_gameObjects.push_back(N_Clue3_2);
		m_gameObjects.push_back(N_Clue4_1);
		m_gameObjects.push_back(N_Clue4_2);*/
		m_gameObjects.push_back(Divider1);


		m_gameObjects.push_back(LastActivity);
		/*m_gameObjects.push_back(N_LA1);
		m_gameObjects.push_back(N_LA2);*/
