...
public:
	...
	EndScene() :audioManager(AudioManager::GetInstance())
	{
		...
		audioManager.LoadSound("EndingSceneBGMusic", "Assets/Sounds/BGmusic_EndingCutscene.mp3", 1.0f);
		audioManager.LoadSound("NewspaperSlam", "Assets/Sounds/SFX_EndingNewspaperSlam.mp3", 1.0f);
	...
	void OnExit() override {
		...
		audioManager.StopSound("EndingSceneBGMusic");
